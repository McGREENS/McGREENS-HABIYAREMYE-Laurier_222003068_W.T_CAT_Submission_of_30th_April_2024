     ...
     <div class="container-fluid container-service py-5">
        <div class="container pt-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3">Reliable & High-Quality Ambulance Service</h1>
                <p class="mb-5">With years of experience in providing urgent medical care, our responders are adept at navigating the unique challenges of emergency situations in Rwanda. </p>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Real-Time Availability</h4>
                            <p class="mb-4">Displays real-time information about the availability of ambulances, ensuring prompt response to emergencies.</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Location Tracking</h4>
                            <p class="mb-4">Utilizes GPS technology to track the location of ambulances and provide accurate estimated arrival times.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Automated Dispatch</h4>
                            <p class="mb-4">Automatically assigns the nearest available ambulance to an emergency, optimizing response times.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Emergency Alerts</h4>
                            <p class="mb-4">We Send notifications and alerts to emergency responders and healthcare facilities in case of critical situations or changes in status.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Route Optimization</h4>
                            <p class="mb-4">Calculates the most efficient route for ambulance dispatch based on traffic conditions.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Blood Transfusion</h4>
                            <p class="mb-4">Caring for our community's health and well-being, our ambulance service proudly offers professional blood transfusion services.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Online Booking</h4>
                            <p class="mb-4">Allows users to request ambulance services online through a website or mobile app, providing convenience and accessibility.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">Multi-Language Support</h4>
                            <p class="mb-4">Provides support for multiple languages to accommodate diverse populations and ensure clear communication during emergency situations, improving accessibility and inclusivity.</p>
                        <a class="btn btn-light px-3" href="">Read More<i class="bi bi-chevron-double-right ms-1"></i></a>
                    </div>
                </div>
            </div>
...
if ($result->num_rows > 0) {
    ...
    echo "No Testimonials Available For Now.";
}
...
?>
    ...
    <a href="service.php" class="btn btn-lg btn-primary btn-lg-square rounded-circle back-to-top"><i class="bi bi-arrow-up"></i></a>
